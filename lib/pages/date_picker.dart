...
class DatePickerPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    void _onSelectionChanged(DateRangePickerSelectionChangedArgs args) {
      ...
      ref.read(startDateProvider.notifier).update((state) => format.format(args.value.startDate));
      ref.read(endDateProvider.notifier).update((state) => format.format(args.value.endDate));
      print(startDate);
      print(endDate);
    }
